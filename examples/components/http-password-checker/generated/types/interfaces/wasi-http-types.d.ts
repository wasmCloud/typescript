...
declare module 'wasi:http/types@0.2.2' {
  ...
  export type Duration = import('wasi:clocks/monotonic-clock@0.2.2').Duration;
  export type InputStream = import('wasi:io/streams@0.2.2').InputStream;
  export type OutputStream = import('wasi:io/streams@0.2.2').OutputStream;
  export type IoError = import('wasi:io/error@0.2.2').Error;
